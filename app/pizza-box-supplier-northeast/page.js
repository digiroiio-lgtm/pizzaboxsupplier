...
import { SITE_URL, BRAND, regionPages, portPages, products } from '@/lib/content'
import { BreadcrumbNav, LeadForm } from '@/components/sections'

const region = regionPages.find(r => r.slug === 'pizza-box-supplier-northeast')
const relatedPort = portPages.find(p => p.slug === region.primaryPortSlug)
...
const breadcrumbs = [
  { label: 'Home', href: '/' },
  { label: 'Pizza Box Supplier — Northeast USA' },
]

const stateLinks = [
  { label: 'New York', href: '/pizza-box-supplier-new-york' },
  { label: 'New Jersey', href: '/pizza-box-supplier-new-jersey' },
    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-600 max-w-3xl leading-relaxed text-lg">
          Container-volume pizza box supply for Northeast U.S. distributors and buyers. Programs covering New York, New Jersey, Pennsylvania, Massachusetts, Connecticut and surrounding states, with freight planning through the Port of New York and New Jersey.
        </p>
      </div>

      <section className="mb-12">
        <h2 style={{ color: 'var(--color-wpb-navy)' }} className="text-xl font-bold mb-4">Northeast Supply Programs</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
          {region.buyerContext}
        </p>
        <p className="text-gray-600 leading-relaxed">
          Container-volume programs include wholesale pricing, pallet-scale ordering, custom printing and private-label options. Freight planning for Northeast destinations is available as part of the container program.
        </p>
      </section>
      ...
      <section className="mb-12 p-5 rounded-xl" style={{ background: 'var(--color-wpb-gray)', border: '1px solid var(--color-wpb-gray-border)' }}>
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <div className="text-sm text-gray-500 mt-1">Container entry point for Northeast distribution</div>
          </div>
      ...
      <section className="mb-12">
        <h2 style={{ color: 'var(--color-wpb-navy)' }} className="text-xl font-bold mb-4">Northeast States Covered</h2>
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            { label: 'Southeast', href: '/pizza-box-supplier-southeast', desc: 'Georgia, Florida — Port of Savannah' },
      ...
      <section style={{ background: 'var(--color-wpb-gray)', borderRadius: '12px' }} className="p-6 sm:p-10">
        <h2 style={{ color: 'var(--color-wpb-navy)' }} className="text-2xl font-bold mb-3 text-center">Request Pricing — Northeast</h2>
        <p className="text-gray-600 text-center mb-8">Container and pallet programs for Northeast buyers.</p>
