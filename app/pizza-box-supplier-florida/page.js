    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-600 max-w-3xl leading-relaxed text-lg">
          Wholesale pizza box supply for Florida buyers. Container-volume programs for foodservice distributors and high-volume buyers across Miami, Tampa, Orlando and Jacksonville. Freight planning through the Port of Savannah.
        </p>
      </div>

      <section className="mb-12">
        <h2 style={{ color: 'var(--color-wpb-navy)' }} className="text-xl font-bold mb-4">Florida Supply Programs</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
          {page.buyerContext}
        </p>
        <p className="text-gray-600 leading-relaxed">
          Container and pallet programs with freight coordination for Florida delivery destinations. All standard pizza box types and sizes available. Custom printing and private-label options for chain and franchise operators.
        </p>
      </section>
      ...
      <section style={{ background: 'var(--color-wpb-gray)', borderRadius: '12px' }} className="p-6 sm:p-10">
        <h2 style={{ color: 'var(--color-wpb-navy)' }} className="text-2xl font-bold mb-3 text-center">Request Pricing — Florida</h2>
        <p className="text-gray-600 text-center mb-8">Container and pallet programs for Florida buyers.</p>
