...
const page = statePages.find(p => p.slug === 'pizza-box-supplier-georgia')
...
const breadcrumbs = [
  { label: 'Home', href: '/' },
  { label: 'Southeast', href: '/pizza-box-supplier-southeast' },
  { label: 'Georgia' },
]
    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-600 max-w-3xl leading-relaxed text-lg">
          Wholesale pizza box supply for Georgia buyers. Container-volume programs with freight planning through the Port of Savannah for Atlanta and Southeast distributors and high-volume buyers.
        </p>
      </div>

      <section className="mb-12">
        <h2 style={{ color: 'var(--color-wpb-navy)' }} className="text-xl font-bold mb-4">Georgia Supply Programs</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
          {page.buyerContext}
        </p>
        <p className="text-gray-600 leading-relaxed">
          Container and pallet programs with freight coordination for Georgia and Southeast delivery destinations. All standard pizza box types and sizes available. Custom printing and private-label options available.
        </p>
      </section>
      ...
      <section className="mb-10 p-5 rounded-xl" style={{ background: 'var(--color-wpb-gray)', border: '1px solid var(--color-wpb-gray-border)' }}>
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <div className="text-sm text-gray-500 mt-1">~4 hours by truck to Atlanta</div>
          </div>
      ...
      <section style={{ background: 'var(--color-wpb-gray)', borderRadius: '12px' }} className="p-6 sm:p-10">
        <h2 style={{ color: 'var(--color-wpb-navy)' }} className="text-2xl font-bold mb-3 text-center">Request Pricing — Georgia</h2>
        <p className="text-gray-600 text-center mb-8">Container and pallet programs for Georgia buyers.</p>
