...
const page = statePages.find(p => p.slug === 'pizza-box-supplier-pennsylvania')
    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-600 max-w-3xl leading-relaxed text-lg">
          Wholesale pizza box supply for Pennsylvania buyers. Container-volume programs for foodservice distributors in Philadelphia, Pittsburgh and the Central PA corridor. Freight planning through the Port of New York and New Jersey.
        </p>
      </div>

      <section className="mb-12">
        <h2 style={{ color: 'var(--color-wpb-navy)' }} className="text-xl font-bold mb-4">Pennsylvania Supply Programs</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
          {page.buyerContext}
        </p>
        <p className="text-gray-600 leading-relaxed">
          Available products include all standard pizza box types and sizes. Container and pallet programs with freight coordination for Pennsylvania delivery destinations. Custom printing and private-label options available.
        </p>
      </section>
      ...
      <section style={{ background: 'var(--color-wpb-gray)', borderRadius: '12px' }} className="p-6 sm:p-10">
        <h2 style={{ color: 'var(--color-wpb-navy)' }} className="text-2xl font-bold mb-3 text-center">Request Pricing — Pennsylvania</h2>
        <p className="text-gray-600 text-center mb-8">Container and pallet programs for Pennsylvania buyers.</p>
