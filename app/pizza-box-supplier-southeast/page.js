...
const breadcrumbs = [
  { label: 'Home', href: '/' },
  { label: 'Pizza Box Supplier — Southeast USA' },
]

const stateLinks = [
  { label: 'Georgia', href: '/pizza-box-supplier-georgia' },
  { label: 'Florida', href: '/pizza-box-supplier-florida' },
]

export default function SoutheastPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-600 max-w-3xl leading-relaxed text-lg">
          Container-volume pizza box supply for Southeast U.S. distributors and buyers in Georgia, Florida, South Carolina and surrounding states. Freight planning through the Port of Savannah for efficient Southeast distribution.
        </p>
      </div>

      <section className="mb-12">
        <h2 style={{ color: 'var(--color-wpb-navy)' }} className="text-xl font-bold mb-4">Southeast Supply Programs</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
          {region.buyerContext}
        </p>
        <p className="text-gray-600 leading-relaxed">
          Container programs include wholesale pricing, pallet-scale ordering, custom printing and private-label options. Freight coordination for Southeast destinations from the Port of Savannah is part of the program.
        </p>
      </section>
      ...
      <section className="mb-12 p-5 rounded-xl" style={{ background: 'var(--color-wpb-gray)', border: '1px solid var(--color-wpb-gray-border)' }}>
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <div className="text-sm text-gray-500 mt-1">Container entry point for Southeast distribution</div>
          </div>
      ...
      <section className="mb-12">
        <h2 style={{ color: 'var(--color-wpb-navy)' }} className="text-xl font-bold mb-4">Southeast States Covered</h2>
      ...
      <section style={{ background: 'var(--color-wpb-gray)', borderRadius: '12px' }} className="p-6 sm:p-10">
        <h2 style={{ color: 'var(--color-wpb-navy)' }} className="text-2xl font-bold mb-3 text-center">Request Pricing — Southeast</h2>
        <p className="text-gray-600 text-center mb-8">Container and pallet programs for Southeast buyers.</p>
